  ...
  return (
    <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 text-center">
      ...
      <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
        {/*  */}
        {blogs?.splice(1,3)?.map((blog,i) => {
          return (
            <div key={i} className="overflow-hidden transition-shadow duration-300 bg-white rounded">
      ...
      <Link href="/routes/allBlogs" className="bg-slate-700 text-center mx-auto sm:px-[36px] lg:px-[46px] mt-5 py-3 sm:text-[18px] lg:text-[24px] rounded text-white font-bold ">See All</Link>
      </section>
    </div>
  );
};
